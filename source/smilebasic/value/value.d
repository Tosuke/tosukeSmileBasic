...
struct Value {
  ...
  int dimension() @property const {
    ...
    case ValueType.Floater:
      return 0;
    case ValueType.String:
      return this.get!StringValue.dimension;
    case ValueType.Array:
      return this.get!ArrayValue.dimension;
    }
  }
  ...
  @property {
    ///ditto
    public ValueType type() const {
      return type_;
    }

    private void type(ValueType a) {
      type_ = a;
    }
  }
  ...
  string toString() const {
    ...
    case ValueType.Undefined:
      return "undefined";
    case ValueType.Integer:
      return this.get!int.to!string;
    case ValueType.Floater:
      return this.get!double.to!string;
    case ValueType.String:
      return `"` ~this.get!wstring.to!string ~ `"`;
    default:
      assert(0);
    }
  }
...
int toBoolean(Value v) {
  switch (v.type) {
  case ValueType.Integer:
    return cast(int)(v.get!int != 0);
  case ValueType.Floater:
    return cast(int)(v.get!double != 0);
  case ValueType.String:
    return 3;
  default:
